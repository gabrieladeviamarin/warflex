...
$sql = $con->prepare("SELECT e.id_sala, e.username as atacante, e.usu_victima, e.daño, a.nom_arma, e.fecha_ini, e.fecha_fin, e.parte_cuerpo 
                      FROM estadistica e
            ...
            <?php if (!empty($estadisticas)): ?>
                <?php foreach ($estadisticas as $fila): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($fila['atacante']); ?></td>
